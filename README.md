...
* _read the shiny new csv into your favorite sql or sql like platform.
* _use either the questions, or get creative and ask your own

## Known Bugs

* _My csv may be a bit larger than i anticipated_and took forever to upload to the cloud console
* _Not sure if setting the index works like it is._
* _Ill know more once i get it in bigquery
